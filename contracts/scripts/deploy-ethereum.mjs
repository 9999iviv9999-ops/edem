...
async function main() {
  const rpcUrl = process.env.ETH_MAINNET_RPC_URL || "https://ethereum.publicnode.com";
  ...
  if (Number(chainId) !== 1) {
    throw new Error(`Expected Ethereum mainnet chainId 1, got ${chainId}. Check ETH_MAINNET_RPC_URL.`);
  }
