...
export const ru = {
  ...
  "market.mintTitle": "Создать NFT",
  "market.mintLede":
    "Минт только для владельца коллекции Genesis. Укажите кошелек получателя и token URI метаданных.",
  "market.mintOwnerOnly": "Минт доступен только кошельку владельца коллекции.",
  "market.mintRecipient": "Кошелек получателя (0x...)",
  "market.mintTokenUri": "Token URI (ipfs://... или https://...)",
  "market.mintAction": "Создать NFT",
  "market.minting": "Создание…",
  "market.mintAndListAction": "Создать и сразу выставить",
  "market.mintAndListing": "Создание и публикация…",
  "market.mintSuccess": "Токен #{{tokenId}} создан. Ниже можно сразу выставить его.",
  "market.listLede":
  ...
  "errors.mint": "Не удалось создать этот NFT.",
  "errors.mintAndList": "Не удалось создать и выставить этот NFT.",
  "errors.mintInvalidInput": "Введите корректный адрес получателя и token URI.",
