export const en = {
  ...
  "market.mintTitle": "Create NFT",
  "market.mintLede":
    "Owner-only mint for the Genesis collection. Enter recipient wallet and token URI metadata.",
  "market.mintOwnerOnly": "Mint is available only for the collection owner wallet.",
  "market.mintRecipient": "Recipient wallet (0x...)",
  "market.mintTokenUri": "Token URI (ipfs://... or https://...)",
  "market.mintAction": "Mint NFT",
  "market.minting": "Minting…",
  "market.mintAndListAction": "Mint and list now",
  "market.mintAndListing": "Minting and listing…",
  "market.mintSuccess": "Minted token #{{tokenId}}. You can list it below.",
  "market.listLede":
  ...
  "errors.mint": "We could not mint this NFT.",
  "errors.mintAndList": "We could not mint and list this NFT.",
  "errors.mintInvalidInput": "Enter a valid recipient address and token URI.",
